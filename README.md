...
O script imprime um link tipo `https://minha-maquina.meu-tailnet.ts.net` — é só mandar esse link. Ele fica no ar enquanto o script estiver rodando; aperte `Ctrl+C` pra encerrar (derruba o servidor e desliga o Funnel automaticamente).
